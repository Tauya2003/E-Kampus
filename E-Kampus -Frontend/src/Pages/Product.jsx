...
const Product = () => {
  ...
  const fetchPData = useCallback(async () => {
    ...
    <div className='border-t-2 pt-10 transition-opacity duration-500 opacity-100'>
        ...
        <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
          ...
          <div className='flex-1 flex flex-col-reverse gap-3 sm:flex-row'>
            <div className='sm:flex-col flex  overflow-hidden justify-between sm:justify-normal sm:w-[18.75%] w-full'>
              {
              ...
              <div className='flex'>
                 <b className='border px-5 py-3 text-sm'>Description</b>
                  ...
                  <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
                    <p>An e-commerce markeplace that facilitates buying</p>
                    <p> A e-commerce site has stuff you can buy</p>
                  </div>
            </div>
