  ...
  const offCampusAccommodations = [
    {
      ...
      description:
        "Limited Services ⏰🏡🫂 🏡Palaces for Kings👦😇 🏡Heaven for Angels👧😇 Secure an affordable home, Away from Home.",
      contact: "0778 292 321 / 0716 063 531",
      email: "info@mushaestates.co.zw",
      whatsapp: "+263778292321",
      fullDescription:
        "Experience luxury living at Musha Estates, offering premium accommodation for students. Our properties feature modern amenities, 24/7 security, and convenient transport links to major universities. Located in prime areas including Mount Pleasant, Groombridge, Borrowdale, Hatcliffe, Avondale, and Emerald Hill.",
      features: [
      ...
      reviews: [
        {
          ...
          name: "John Doe",
          rating: 5,
          text: "Excellent place to stay! Clean, safe and convenient.",
          date: "2024-01-15",
        },
        {
          id: 2,
          name: "Mary Smith",
          rating: 4,
          text: "Good location and friendly staff. Transport service is reliable.",
          date: "2024-01-10",
        },
        {
          id: 3,
          name: "Peter Jones",
          rating: 5,
          text: "Best accommodation I've stayed in. Highly recommend!",
          date: "2024-01-05",
        },
      ],
    },
    {
      ...
      description:
        "Exclusive accommodation for male students with modern amenities and secure facilities.",
      contact: "0712 345 678",
      email: "bookings@menonly.co.zw",
      whatsapp: "+263712345678",
      fullDescription:
        "Men Only Residence provides a focused living environment specifically designed for male students. Our facility offers a quiet, study-conducive atmosphere with modern amenities and excellent security measures.",
      features: [
      ...
      reviews: [
        {
          ...
          name: "David Wilson",
          rating: 4,
          text: "Great place for studying. Very quiet and peaceful.",
          date: "2024-01-20",
        },
        {
          id: 2,
          name: "Mike Brown",
          rating: 4,
          text: "Good facilities, especially the gym. Staff is helpful.",
          date: "2024-01-12",
        },
      ],
    },
    {
      ...
      description:
        "Premium student accommodation with luxury amenities including swimming pool and on-site restaurant.",
      contact: "0771 123 456",
      email: "info@elitelodge.co.zw",
      whatsapp: "+263771123456",
      fullDescription:
        "Elite Student Lodge offers the pinnacle of student accommodation with luxury amenities and services. Perfect for students who want comfort and convenience during their studies.",
      features: [
      ...
      reviews: [
        {
          ...
          name: "Sarah Johnson",
          rating: 5,
          text: "Amazing place! The pool and restaurant make it feel like a hotel.",
          date: "2024-01-25",
        },
        {
          id: 2,
          name: "Alex Chen",
          rating: 5,
          text: "Worth every penny. Best student accommodation in Harare!",
          date: "2024-01-18",
        },
        {
          id: 3,
          name: "Emma Davis",
          rating: 4,
          text: "Great facilities but a bit pricey. Still recommend it.",
          date: "2024-01-14",
        },
      ],
    },
    {
      ...
      description:
        "Affordable apartments with great views of the university campus. Perfect for budget-conscious students.",
      contact: "0773 987 654",
      email: "bookings@campusview.co.zw",
      whatsapp: "+263773987654",
      fullDescription:
        "Campus View Apartments offer affordable yet comfortable accommodation with stunning views of the university campus. Ideal for students who want independence with shared amenities.",
      features: [
      ...
      reviews: [
        {
          ...
          name: "James Miller",
          rating: 4,
          text: "Great value for money. Love the campus views!",
          date: "2024-01-22",
        },
        {
          id: 2,
          name: "Lisa Taylor",
          rating: 4,
          text: "Good basic accommodation. Kitchen facilities are clean.",
          date: "2024-01-16",
        },
      ],
    },
    {
      ...
      description:
        "Peaceful accommodation surrounded by beautiful gardens with a quiet library and cafeteria on-site.",
      contact: "0774 456 789",
      email: "info@gardencity.co.zw",
      whatsapp: "+263774456789",
      fullDescription:
        "Garden City Residence provides a serene living environment surrounded by lush gardens. Our facility combines nature with modern amenities to create the perfect study environment.",
      features: [
      ...
      reviews: [
        {
          ...
          name: "Rachel Green",
          rating: 5,
          text: "Beautiful place! The gardens are so peaceful for studying.",
          date: "2024-01-28",
        },
        {
          id: 2,
          name: "Tom Anderson",
          rating: 4,
          text: "Great environment for studies. Library is well-equipped.",
          date: "2024-01-21",
        },
        {
          id: 3,
          name: "Nina Patel",
          rating: 4,
          text: "Love the garden setting. Very relaxing after long study sessions.",
          date: "2024-01-17",
        },
      ],
    },
    {
      ...
      description:
        "Modern tech-focused accommodation with computer labs, co-working spaces, and gaming areas for tech students.",
      contact: "0775 111 222",
      email: "hello@techhub.co.zw",
      whatsapp: "+263775111222",
      fullDescription:
        "Tech Hub Student Center is designed specifically for technology and engineering students. With state-of-the-art computer labs, co-working spaces, and high-tech amenities throughout.",
      features: [
      ...
      reviews: [
        {
          ...
          name: "Kevin Zhang",
          rating: 5,
          text: "Perfect for CS students! The tech facilities are incredible.",
          date: "2024-01-30",
        },
        {
          id: 2,
          name: "Priya Singh",
          rating: 5,
          text: "Amazing co-working spaces and the 3D printer is a bonus!",
          date: "2024-01-26",
        },
        {
          id: 3,
          name: "Marcus Johnson",
          rating: 4,
          text: "Great for group projects. Gaming area is fun for stress relief.",
          date: "2024-01-23",
        },
      ],
    },
    ...
    return () => {
      ScrollTrigger.getAll().forEach((trigger) => {
        if (
          ...
          accommodationCardsRef.current.includes(trigger.vars.trigger)
        ) {
          trigger.kill();
        }
      });
    ...
    <div className="container-padding py-8 flex flex-col items-center">
      ...
      <div ref={onCampusRef} className="w-full max-w-4xl mx-auto mb-12">
        <h2 className="text-center mb-8 text-xl">
         <Title text1={"ON-CAMPUS"} text2={"ACCOMMODATION"} />
        </h2>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <p className="text-sm text-blue-700 font-medium">
                Offering the best accommodation for our Students! Visit the
                Students Affairs office for accommodation for more information.
                Located at the Students Affairs (1st floor, Office 234).
              </p>
            </div>
          </div>
        </div>
      ...
      <div ref={contentRef} className="w-full max-w-6xl mx-auto">
        <h2 className="text-xl mb-8 text-center">
          <Title text1={"OFF-CAMPUS"} text2={"ACCOMMODATION"} />
        </h2>
              ...
              <div className="accommodation-content">
                ...
                <div className="accommodation-amenities">
                  {accommodation.amenities.slice(0, 3).map((amenity, index) => (
                    <span key={index} className="accommodation-amenity">
                      {amenity}
                    </span>
                  ))}
                  {accommodation.amenities.length > 3 && (
                    <span className="accommodation-amenity">
              ...
              <div className="main-image-container">
                ...
                <div className="gallery-controls">
                  ...
                  <button
                    ...
                    onClick={() =>
                      setSelectedImageIndex((prev) =>
                        prev === selectedAccommodation.images.length - 1
                          ? 0
                          : prev + 1
                      )
                    }
                ...
                <div className="image-indicator">
                  ...
                  {selectedAccommodation.images.length}
                </div>
              </div>
              ...
              <div className="modal-title-section">
                ...
                <div className="modal-rating">
                  ...
                  <span className="review-count">
                    ({selectedAccommodation.reviews.length} reviews)
                  </span>
                </div>
              </div>
              ...
              <div className="modal-section">
                ...
                <div className="contact-info">
                  <p className="modal-contact">
                    📞 {selectedAccommodation.contact}
                  </p>
                  <p className="modal-contact">
                    📧 {selectedAccommodation.email}
                  </p>
                  <p className="modal-contact">
                    💬 {selectedAccommodation.whatsapp}
                  </p>
                </div>
              </div>

              <div className="modal-actions">
                <Button variant="outline" className="flex-1 w-full" onClick={handleContactNow}>
                  Contact Now
                </Button>
                <Button variant="black" className="flex-1 w-full" onClick={handleBookVisit}>
                  Book Visit
                </Button>
              </div>
            </div>
