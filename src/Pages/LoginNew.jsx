...
const LoginNew = () => {
  ...
  const validateForm = () => {
    ...
    if (currentState === "Sign Up" && formData.confirmPassword) {
      ...
      if (!confirmValidation.isValid)
        errors.confirmPassword = confirmValidation;
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-slate-100 flex items-center justify-center px-4 pt-8 pb-20">
      <div className="w-full max-w-md">
        <div
          ref={formRef}
          className="bg-white shadow-xl p-8 border border-slate-200"
        >
          {/* Header */}
            ...
            >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full pl-10 pr-12 py-3 border rounded-none focus:ring-0 focus:border-transparent transition-all duration-200 ${
                    validation.password && !validation.password.isValid
                      ? "border-red-300 bg-red-50"
                      : "border-gray-300 hover:border-gray-400"
                  }`}
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full pl-10 pr-12 py-3 border rounded-none focus:ring-2 focus:border-transparent transition-all duration-200 ${
              ...
              >
                <label className="flex items-center">
                  <input
                    ...
                    className="w-4 h-4 text-black bg-gray-100 border-gray-300 rounded focus:ring-black/80 focus:ring-2"
                  />
